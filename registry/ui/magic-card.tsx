...
function MagicCardNew({ className, gradientColor = "conic-gradient(from 90deg at 50% 50%, #E2CBFF 0%, #393BB2 50%, #E2CBFF 100%)", ...props }: React.ComponentProps<"div"> & { gradientColor?: string }) {
    return (
        <div
