...
import { DocsNavItem } from "@/lib/docs-config";
...
interface ComponentsGalleryClientProps {
  allComponents: DocsNavItem[];
}

export default function ComponentsGalleryClient({ allComponents }: ComponentsGalleryClientProps) {
  return (
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Browse all {allComponents.length}+ beautifully designed, accessible React UI components available in Nyxhora UI. Copy-paste into your project and customize with Tailwind CSS.
            </p>
          </div>
