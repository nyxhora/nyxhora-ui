...
export function SimpleModeToggle() {
  ...
  return (
    <Button
      ...
      className="relative h-8 w-8 rounded-full  hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 ease-in-out shadow-sm hover:shadow-md backdrop-blur-sm"
    >
